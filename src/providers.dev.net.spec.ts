...
describe("test network providers on devnet: Proxy and API", function () {
    ...
    let apiProvider: INetworkProvider = new ApiNetworkProvider("https://devnet-api.dharitri.com", { timeout: 10000, clientName: 'test' });
    let proxyProvider: INetworkProvider = new ProxyNetworkProvider("https://devnet-gateway.dharitri.com", { timeout: 10000, clientName: 'test' });
    ...
    it("should add userAgent unknown for clientName when no clientName passed", async function () {
        ...
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.com", { timeout: 10000 });
    ...
    it("should set userAgent with specified clientName ", async function () {
        ...
        let localApiProvider: any = new ApiNetworkProvider("https://devnet-api.dharitri.com", { timeout: 10000, clientName: 'test' });
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.com", { timeout: 10000, clientName: 'test' });
    ...
    it("should keep the set userAgent and add the sdk to it", async function () {
        ...
        let localApiProvider: any = new ApiNetworkProvider("https://devnet-api.dharitri.com", { timeout: 10000, headers: new AxiosHeaders({ "User-Agent": "Client-info" }), clientName: 'test' });
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.com", { timeout: 10000, headers: new AxiosHeaders({ "User-Agent": "Client-info" }), clientName: 'test' });
    ...
    it("should have same response for queryContract()", async function () {
        ...
        let query = new MockQuery({
            address: new Address("drt1qqqqqqqqqqqqqpgqfzydqmdw7m2vazsp6u5p95yxz76t2p9rd8ssj7kxgwqqqqqqqqqqqqqpgqfzydqmdw7m2vazsp6u5p95yxz76t2p9rd8ss0zp9ts"),
            func: "getSum"
        });
